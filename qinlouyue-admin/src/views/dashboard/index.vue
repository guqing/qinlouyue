<template>
  <div class="dashboard-container">
    <div class="dashboard-text">
      欢迎光临:{{ name }}(<span v-for="role in roles" :key="role">{{
        role
      }}</span
      >)
    </div>
      ...
      <el-col :span="12">
        <el-collapse class="section">
          ...
          <el-collapse-item title="商标注册服务低至8折" name="5">
            <div>
              <a href="https://tm.aliyun.com/?userCode=alts44ap" target="_blank"
                >点击查看详情</a
              >
            </div>
          </el-collapse-item>
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-table :data="tableData" class="section">
          ...
          <el-table-column prop="address" :label="$t('dashboard.addr')">
          </el-table-column>
        </el-table>
      </el-col>
