      ...
      return {
        cfgName: [
          ...
          },
          {
            ...
            max: 2000,
            message:
              this.$t('config.name') + this.$t('config.lengthValidation'),
            trigger: 'blur'
          }
        ],
        cfgValue: [
          ...
          },
          {
            ...
            max: 2000,
            message:
              this.$t('config.value') + this.$t('config.lengthValidation'),
            trigger: 'blur'
          }
        ]
      }
    ...
    exportXls() {
      exportXls(this.listQuery).then(response => {
        window.location.href =
          getApiUrl() + '/file/download?idFile=' + response.data.id
      })
    }
  }
}
