...
import xyz.guqing.app.bean.dictmap.MenuDict;
import xyz.guqing.app.bean.entity.system.Menu;
...
import xyz.guqing.app.bean.vo.node.MenuNode;
...
import xyz.guqing.app.service.system.MenuService;
...
public class MenuController extends BaseController {
    ...
    public Object menuTreeListByRoleId(Integer roleId) {
        ...
        Map<Long,ZTreeNode> map = xyz.guqing.app.utils.Lists.toMap(roleTreeList,"id");
        Map<Long,List<ZTreeNode>> group = xyz.guqing.app.utils.Lists.group(roleTreeList,"pId");
